...
public class TimePickerDialog extends DialogFragment implements
    ...
    public static TimePickerDialog newInstance(OnTimeSetListener callback, OnHourSelectedListener callbackHour,
        ...
        ret.initialize(callback, callbackHour, callbackMinute, hourOfDay, minute, second, is24HourMode);
        return ret;
    }
    ...
    public static TimePickerDialog newInstance(OnTimeSetListener callback,  OnHourSelectedListener callbackHour,
        ...
        return TimePickerDialog.newInstance(callback, callbackHour, callbackMinute, hourOfDay, minute, 0, is24HourMode);
    }
