...
public class TimePickerDialog extends AppCompatDialogFragment implements
    ...
    private OnOkListener mOkCallback;
    private OnClickedPendingAlarms mCallbackPendingAlarm;
    private OnClickedShareAlarm mCallbackShareAlarm;
    ...
    public static TimePickerDialog newInstance(OnTimeSetListener callback, OnHourSelectedListener callbackHour,
                                               OnMinuteSelectedListener callbackMinute, OnOkListener callbackOk,
                                               OnClickedPendingAlarms callbackPendingAlarms, OnClickedShareAlarm callbackShareAlarm,
                                               int hourOfDay, int minute, int second, boolean is24HourMode) {
        TimePickerDialog ret = new TimePickerDialog();
        ret.initialize(callback, callbackHour, callbackMinute, callbackOk, callbackPendingAlarms, callbackShareAlarm,
                hourOfDay, minute, second, is24HourMode);
        return ret;
    }
    ...
    public static TimePickerDialog newInstance(OnTimeSetListener callback, OnHourSelectedListener callbackHour,
        ...
        return TimePickerDialog.newInstance(callback, callbackHour, callbackMinute, callbackOk, callbackPendingAlarms,
                callbackShareAlarm, hourOfDay,
   ...
   /* public static TimePickerDialog newInstance(OnTimeSetListener callback, OnHourSelectedListener callbackHour,
                                               OnMinuteSelectedListener  callbackMinute, boolean is24HourMode) {
        Calendar now = Calendar.getInstance();
        return TimePickerDialog.newInstance(callback, callbackHour, callbackMinute, now.get(Calendar.HOUR_OF_DAY), now.get(Calendar.MINUTE), is24HourMode);
    }*/

    public static TimePickerDialog newInstance(OnTimeSetListener callback, OnHourSelectedListener callbackHour,
                                               OnMinuteSelectedListener callbackMinute,
                                               OnClickedPendingAlarms callbackPendingAlarms, OnClickedShareAlarm callbackShareAlarm,
                                               OnOkListener callbackOk, boolean is24HourMode) {
        Calendar now = Calendar.getInstance();
        return TimePickerDialog.newInstance(callback, callbackHour, callbackMinute, callbackOk,
                callbackPendingAlarms, callbackShareAlarm,
    ...
    public void initialize(OnTimeSetListener callback, OnHourSelectedListener callbackHour,
                           OnMinuteSelectedListener callbackMinute, OnOkListener callbackOk,
                           OnClickedPendingAlarms callbackPendingAlarms, OnClickedShareAlarm callbackShareAlarm,
                           int hourOfDay, int minute, int second, boolean is24HourMode) {
        mCallback = callback;
        mHourCallback = callbackHour;
        mMinuteCallback = callbackMinute;
        mOkCallback = callbackOk;
        mCallbackPendingAlarm = callbackPendingAlarms;
        mCallbackShareAlarm = callbackShareAlarm;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int viewRes = mVersion == Version.VERSION_1 ? R.layout.mdtp_time_picker_dialog : R.layout.mdtp_time_picker_dialog;
        ...
        view.findViewById(R.id.pendingAlarms).setOnClickListener(v -> {
            mCallbackPendingAlarm.onPendingAlarms();
        });

        view.findViewById(R.id.shareAlarm).setOnClickListener(v -> {
            mCallbackShareAlarm.shareAlarm();
        });
    ...
    private void setHour(int value, boolean announce) {
        ...
        mHourCallback.onHourSelected(value);
    ...
    private void setMinute(int value) {
        ...
        mMinuteCallback.onMinuteSelected(value);
    ...
    public void notifyOnDateListener() {
        ...
        if (mHourCallback != null) {
            mHourCallback.onHourSelected(mTimePicker.getHours());
        }
        if (mMinuteCallback != null) {
            mMinuteCallback.onMinuteSelected(mTimePicker.getMinutes());
        }
    }
    ...
    public interface OnClickedPendingAlarms {
        void onPendingAlarms();
    }

    public interface OnClickedShareAlarm {
        void shareAlarm();
    }
